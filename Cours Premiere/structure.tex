...
\definecolor{Hred}{HTML}{B70E0B} % Define the orange color used for highlighting throughout the book
\definecolor{Hblue}{HTML}{165479}
...
\newenvironment{exercise}{\begin{eBox}\begin{exerciseT}\text{ }\\}{\hfill{\color{Hred}\tiny\ensuremath{\blacksquare}}\end{exerciseT}\end{eBox}}
\newenvironment{definition}{\begin{eBox}\begin{definitionT}\text{ }\\}{\end{definitionT}\end{eBox}}	
...
\titleformat{\chapter}[block]{\color{Hblue}\LARGE\bfseries\filcenter}{\color{Hred}\Huge\it\bfseries Chapitre \thechapter}{0pt}{\\}
...
%\draw[anchor=west] (\Gm@lmargin,-9cm) node [line width=2pt,rounded corners=15pt,draw=Hred,fill=white,fill opacity=0.5,inner sep=15pt]{\strut\makebox[22cm]{}};
...
%
%\usepackage{hyperref}
%\hypersetup{hidelinks,backref=true,pagebackref=true,hyperindex=true,colorlinks=false,breaklinks=true,urlcolor= Hred,bookmarks=true,bookmarksopen=false,pdftitle={Title},pdfauthor={Author}}
%\usepackage{bookmark}
%\bookmarksetup{
%open,
%numbered,
